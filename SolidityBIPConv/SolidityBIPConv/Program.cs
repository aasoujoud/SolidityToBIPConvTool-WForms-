...
public class Program
{
    ...
    {
        Console.WriteLine("model Globalmodel" + "\n" + // WRITE TO FILE ////////////////////
                               "port type ePort" + "\n" +
    ...
    public static void SeparateFunction(string text, string ContractName)
    {
        ...
        Console.WriteLine("atomic type " + ContractName+ "\n"); // Write To File Function ///////////////////////////////////////////////
                                                         // define ports
 ...
 // define states
        ...
        Console.Write(JoinedStates); // Write To File Function ///////////////////////////////////////////////
        Console.WriteLine(initial_state + "\n"); // Write To File Function ///////////////////////////////////////////////
 // set initial states
        ...
        {
            Console.WriteLine(s);  // Write To File Function ///////////////////////////////////////////////
        }


        Console.WriteLine("end");  // Write To File Function ///////////////////////////////////////////////
                                   //connectors
    ...
    {
        Console.WriteLine("compound type globModel  \n"); // Write To File Function ///////////////////////////////////////////////
        foreach (string s in ContractNameList)
        {
            Console.WriteLine("component " + s + " "+ s+"1" ); // Write To File Function ///////////////////////////////////////////////
        }
